	...
	<div align="center">
		...
		<form action="${editDoctor.id}" method="post">
			<table border="0">
				...
				<tr>
					<spring:bind path="editOwner.firstname">
						<td><label for="firstname">&nbsp;&nbsp;First
								Name:&nbsp;&nbsp;</label></td>
						<td><form:input path="editOwner.firstname"
				...
				<tr>
					<spring:bind path="editOwner.lastname">
						<td><label for="lastname">&nbsp;&nbsp;Last
								Name:&nbsp;&nbsp;</label></td>
						<td><form:input path="editOwner.lastname"
				...
				<tr>
					<spring:bind path="editOwner.email">
						<td><label for="email">&nbsp;&nbsp;
								Email:&nbsp;&nbsp;</label></td>
						<td><form:input path="editOwner.email" class="form-control"
								id="email" /></td>
				...
				<tr>
					<spring:bind path="editOwner.city">
						<td><label for="city">&nbsp;&nbsp; City:&nbsp;&nbsp;</label></td>
						<td><form:input path="editOwner.city" class="form-control"
								id="city" /></td>
				...
				<tr>
					<spring:bind path="editOwner.housenumber">
						<td><label for="housenumber">&nbsp;&nbsp; House
								Number:&nbsp;&nbsp;</label></td>
						<td><form:input path="editOwner.housenumber"
				...
				<tr>
					<spring:bind path="editOwner.statename">
						<td><label for="statename">&nbsp;&nbsp;
								State:&nbsp;&nbsp;</label></td>
						<td><form:input path="editOwner.statename"
				...
				<tr>
					<spring:bind path="editOwner.streetnumber">
						<td><label for="streetNumber">&nbsp;&nbsp; Street
								Number:&nbsp;&nbsp;</label></td>
						<td><form:input path="editOwner.streetnumber"
				...
				<tr>
					<spring:bind path="editOwner.zipcode">
						<td><label for="zipcode">&nbsp;&nbsp; Zip
								Code:&nbsp;&nbsp;</label></td>
						<td><form:input path="editOwner.zipcode" class="form-control"
								id="zipcode" /></td>
				...
				<tr>
					<spring:bind path="editOwner.phone">
						<td><label for="phone">&nbsp;&nbsp;
								Phone:&nbsp;&nbsp;</label></td>
						<td><form:input path="editOwner.phone" class="form-control"
								id="phone" /></td>
